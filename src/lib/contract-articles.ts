/**
 * 차량 매매 계약서 22개 조항 전문.
 * 원본 docx(260326_계약서_중고매매_심재윤_최종.docx)와 100% 일치.
 * 서명 페이지(app/sign)와 PDF 생성(contract-generator.ts) 양쪽에서 공유.
 */
...
export const CONTRACT_NOTICE = "중요 고지: 본 계약은 자동차 매매 계약이며 렌트 또는 리스 계약이 아닙니다.";
